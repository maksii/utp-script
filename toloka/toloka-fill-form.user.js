...
(function () {
    ...
    function populateForm(form, meta) {
        ...
        if (config.type === 'movie') {
            ...
            if (fields.sub_lang) {
                // Include all subtitle tracks (including Forced) so each gets correct lang/type/format (e.g. Ukrainian Forced → srt, Ukrainian Full → ass)
                const textToFill = tracks.text;
            ...
            if (fields.sub_lang) {
                // Include all subtitle tracks (including Forced) so each gets correct lang/type/format
                const textToFill = tracks.text;
                ensureRows(form, `select[name="${fields.sub_lang}"]`, textToFill.length);
                textToFill.forEach((tr, i) => {
                    const subFmt = safeStr(tr.Format || tr.CodecID || '');
